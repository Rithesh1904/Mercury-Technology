          ...
          <Row className="gy-5 justify-content-between align-items-start">
            ...
            <Col lg={2} md={4} xs={6} className="text-center text-lg-start">
              ...
              <div className="d-flex flex-column gap-3">
                <span onClick={() => handleNav('home')} className="footer-link" style={{ color: 'rgba(255, 255, 255, 0.7)', cursor: 'pointer', fontSize: 15, transition: 'var(--transition-smooth)' }} onMouseOver={(e) => { e.target.style.color = 'var(--light-blue)'; e.target.style.transform = 'translateX(5px)'; }} onMouseOut={(e) => { e.target.style.color = 'rgba(255, 255, 255, 0.7)'; e.target.style.transform = 'translateX(0)'; }} style={{ display: 'inline-block', transition: 'all 0.3s ease' }}>Home</span>
                <span onClick={() => handleNav('services')} className="footer-link" style={{ color: 'rgba(255, 255, 255, 0.7)', cursor: 'pointer', fontSize: 15, transition: 'var(--transition-smooth)' }} onMouseOver={(e) => { e.target.style.color = 'var(--light-blue)'; e.target.style.transform = 'translateX(5px)'; }} onMouseOut={(e) => { e.target.style.color = 'rgba(255, 255, 255, 0.7)'; e.target.style.transform = 'translateX(0)'; }} style={{ display: 'inline-block', transition: 'all 0.3s ease' }}>Services</span>
                <span onClick={() => handleNav('solutions')} className="footer-link" style={{ color: 'rgba(255, 255, 255, 0.7)', cursor: 'pointer', fontSize: 15, transition: 'var(--transition-smooth)' }} onMouseOver={(e) => { e.target.style.color = 'var(--light-blue)'; e.target.style.transform = 'translateX(5px)'; }} onMouseOut={(e) => { e.target.style.color = 'rgba(255, 255, 255, 0.7)'; e.target.style.transform = 'translateX(0)'; }} style={{ display: 'inline-block', transition: 'all 0.3s ease' }}>Solutions</span>
                <span onClick={() => handleNav('contact')} className="footer-link" style={{ color: 'rgba(255, 255, 255, 0.7)', cursor: 'pointer', fontSize: 15, transition: 'var(--transition-smooth)' }} onMouseOver={(e) => { e.target.style.color = 'var(--light-blue)'; e.target.style.transform = 'translateX(5px)'; }} onMouseOut={(e) => { e.target.style.color = 'rgba(255, 255, 255, 0.7)'; e.target.style.transform = 'translateX(0)'; }} style={{ display: 'inline-block', transition: 'all 0.3s ease' }}>Contact</span>
              </div>
            </Col>
