        ...
        <Container>
          ...
          <Row className="g-4 mt-2">
            <Col lg={4}>
              ...
              >
                <Card className="premium-card h-100 p-4 border-0">
                  <Card.Body>
                    <div className="mb-4 text-primary-blue bg-light-blue d-inline-flex p-3 rounded-circle">
                    ...
                    <p className="fs-6" style={{ lineHeight: 1.8, color: 'var(--text-muted)' }}>To become a global leader in intelligent digital transformation empowering industries through AI and innovation.</p>
                  </Card.Body>
                </Card>
              </motion.div>
            </Col>
              ...
              >
                <Card className="premium-card h-100 p-4 border-0">
                  <Card.Body>
                    ...
                    <p className="fs-6" style={{ lineHeight: 1.8, color: 'var(--text-muted)' }}>To craft future-ready experiences by blending creativity, technology, and strategy—driven by purpose, fueled by passion.</p>
                  </Card.Body>
                </Card>
              </motion.div>
            </Col>
              ...
              >
                <Card className="premium-card h-100 p-4 border-0">
                  <Card.Body>
                    ...
                    <p className="fs-6" style={{ lineHeight: 1.8, color: 'var(--text-muted)' }}>We constantly push boundaries, harnessing emerging technologies to shape intelligent digital solutions for the future.</p>
                  </Card.Body>
                </Card>
              </motion.div>
            </Col>
